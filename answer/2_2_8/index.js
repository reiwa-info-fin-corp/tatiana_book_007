...
*/
const bufLE = Buffer.from('あ', 'utf16le'); // バッファを作成
console.log(bufLE); // <Buffer 42 30>

// LE → BE に変換（swap16 は破壊的なのでコピーして使用）
const bufBE = Buffer.from(bufLE).swap16();
console.log('Swapped to UTF-16BE:', bufBE);// Swapped to UTF-16BE: <Buffer 30 42>

// Base64エンコード
const base64String = bufBE.toString('base64'); // バッファをBase64文字列に変換
console.log(base64String); // MEI=
